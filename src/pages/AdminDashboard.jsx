      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="max-w-5xl mx-auto mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
          <div className="rounded-2xl border border-primary/10 bg-dwm-off-white/60 p-6 shadow-md hover:shadow-xl transition duration-300">
            <h2 className="text-xl font-semibold text-primary mb-2">Users</h2>
            <p className="text-dwm-text-mid leading-relaxed">Review account growth and engagement across the platform.</p>
          </div>
          <div className="rounded-2xl border border-primary/10 bg-dwm-off-white/60 p-6 shadow-md hover:shadow-xl transition duration-300">
            <h2 className="text-xl font-semibold text-primary mb-2">Orders</h2>
            <p className="text-dwm-text-mid leading-relaxed">Track marketplace and operational activity from a central view.</p>
          </div>
          <div className="rounded-2xl border border-primary/10 bg-dwm-off-white/60 p-6 shadow-md hover:shadow-xl transition duration-300">
            <h2 className="text-xl font-semibold text-primary mb-2">Content</h2>
            <p className="text-dwm-text-mid leading-relaxed">Maintain a clear, trustworthy brand presence across the product.</p>
          </div>
        </div>
      </div>
    </div>
